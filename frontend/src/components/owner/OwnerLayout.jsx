...
export default function OwnerLayout() {
  ...
  const fullName = user?.first_name && user?.last_name 
    ...
    : user?.first_name || user?.company || user?.username || 'Aircraft Owner'
  ...
  return (
    <div className="app-shell">
            ...
            <div className="profile-dropdown">
              ...
              >
                ...
                <div className="profile-info">
                  ...
                  <span className="profile-role">Aircraft Owner</span>
                </div>
                ...
                <div className="dropdown-menu">
                  <div className="dropdown-header">
                    ...
                    <div className="dropdown-user-info">
                      ...
                      <div className="dropdown-user-email">{user?.email || 'owner@nairobi.jet.house'}</div>
                    </div>
                  </div>
                  <div className="dropdown-divider"></div>
                  <button className="dropdown-item" onClick={() => navigate('/owner/profile')}>
      ...
      <style>{`
        /* Owner Layout Styles - Consistent with Admin/Operator/Staff Layout */
        .app-shell {
          display: flex;
          min-height: 100vh;
