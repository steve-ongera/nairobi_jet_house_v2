...
export default function OperatorLayout() {
  ...
  const fullName = user?.first_name && user?.last_name 
    ...
    : user?.first_name || user?.company || user?.username || 'Operator'
  ...
  return (
    <div className="app-shell">
            ...
            <div className="profile-dropdown">
              ...
              >
                ...
                <div className="profile-info">
                  ...
                  <span className="profile-role">Charter Operator</span>
                </div>
                ...
                <div className="dropdown-menu">
                  <div className="dropdown-header">
                    ...
                    <div className="dropdown-user-info">
                      ...
                      <div className="dropdown-user-email">{user?.email || 'operator@nairobi.jet.house'}</div>
                    </div>
                  </div>
                  <div className="dropdown-divider"></div>
                  <button className="dropdown-item" onClick={() => navigate('/operator/profile')}>
                    <i className="bi bi-building"></i>
                    <span>Company Profile</span>
                  </button>
                  <button className="dropdown-item" onClick={() => navigate('/operator/settings')}>
      ...
      <style>{`
        /* Operator Layout Styles - Consistent with Admin Layout */
        .app-shell {
          display: flex;
          min-height: 100vh;
