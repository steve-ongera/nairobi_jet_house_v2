...
export const adminAPI = {
  ...
  createFlightBooking: d       => api.post('/admin/flight-bookings/', d),   // ← ADD
  updateFlightBooking: (id, d) => api.patch(`/admin/flight-bookings/${id}/`, d), // ← ADD
  ...
  updateOperatorAircraftStatus: (id, status) => api.post(`/admin/operator-aircraft/${id}/update_status/`, { status }),
