      ...
      <div className="stat-grid">
        {[
          ...
          <Link 
            ...
            to={to} 
            className="stat-card"
            style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem 1.25rem' }}
          >
            <i className={`bi ${icon}`} style={{ color, fontSize: '1.2rem' }} />
            <span style={{ fontWeight: 500, fontSize: '0.875rem', color: 'var(--navy)' }}>{label}</span>
          </Link>
        ))}
      </div>
    </div>
